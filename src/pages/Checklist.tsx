...
const Checklist = () => {
  ...
  const [tagAccessModification, setTagAccessModification] = useState<"yes" | "no" | null>(null);
  const [untagAccessValue, setUntagAccessValue] = useState("");
  const [tagAccessValue, setTagAccessValue] = useState("");
          ...
          <div className="px-5 py-4 space-y-6 divide-y">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Button
                  variant={tagAccessModification === "yes" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setTagAccessModification("yes")}
                >
                  Oui
                </Button>
                <Button
                  variant={tagAccessModification === "no" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setTagAccessModification("no")}
                >
                  Non
                </Button>
              </div>
                ...
                <div className="flex gap-3 mt-3">
                  <div className="flex-1">
                    ...
                    <Input
                      ...
                      value={untagAccessValue}
                      onChange={(e) => setUntagAccessValue(e.target.value)}
                      className="h-9 text-sm"
                    />
                  </div>
                  <div className="flex-1">
                    ...
                    <Input
                      ...
                      value={tagAccessValue}
                      onChange={(e) => setTagAccessValue(e.target.value)}
                      className="h-9 text-sm"
                    />
                  </div>
                </div>
            ...
            <div className="pt-6">
              ...
              <div className="flex gap-2">
                <Button
                  variant={tagIntercoModification === "yes" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setTagIntercoModification("yes")}
                >
                  Oui
                </Button>
                <Button
                  variant={tagIntercoModification === "no" ? "default" : "outline"}
                  size="sm"
                  onClick={() => setTagIntercoModification("no")}
                >
                  Non
                </Button>
              </div>
              {tagIntercoModification === "yes" && (
                <div className="flex gap-3 mt-3">
                  <div className="flex-1">
                    ...
                    <Input
                      placeholder="Ex: VLAN 10"
                      value={untagIntercoValue}
                      onChange={(e) => setUntagIntercoValue(e.target.value)}
                      className="h-9 text-sm"
                    />
                  </div>
                  <div className="flex-1">
                    ...
                    <Input
                      placeholder="Ex: VLAN 20, 30"
                      value={tagIntercoValue}
                      onChange={(e) => setTagIntercoValue(e.target.value)}
                      className="h-9 text-sm"
                    />
                  </div>
                </div>
